...
public class CartController {
	...
	public ModelAndView addCart(ModelMap model, @PathVariable("id") Integer id, Principal principal,HttpServletRequest request,HttpServletResponse response) throws IOException {
